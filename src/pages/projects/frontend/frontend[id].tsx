    ...
    if (!project) {
        return (
            <div className="text-center mt-20 text-red-600 text-xl">
                Project not found. <Link to="/projects/frontend" className="underline text-blue-500">Go back</Link>
            </div>
        );
    }
...
export default FrontendProjectDeatil;