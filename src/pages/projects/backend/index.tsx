...
const backendProjectData: Project[] = [
  {
    id: "portfolio",
...
const BackendProject = ()=>{
    return (
        <div className="max-w-5xl mx-auto p-6">
          <h1 className="text-3xl font-bold mb-6">Backend Projects</h1>
          <div className="grid gap-6 md:grid-cols-2">
            {backendProjectData.map((project) => (
              <Link to={`/projects/backend/${project.id}`} key={project.id}>
